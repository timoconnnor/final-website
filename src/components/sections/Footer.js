  ...
  return (
    <StyledFooterRoot ref={footer}>
      ...
      >
        ...
        <StyledFooterText>Developed by Timothy O'Connor</StyledFooterText>
        <StyledFooterText sx={{ marginBottom: "1rem" }}>
          <StyledViewCodeLink href="https://github.com/timoconnnor/website">
            View the code Here <GitHub sx={{ marginBottom: "-0.2rem" }} />
          </StyledViewCodeLink>
        </StyledFooterText>
      </div>
    </StyledFooterRoot>
